...
const Installation = () => {
  return (
    <div className="p-6 md:p-10 bg-gray-50">
      {/* Header Section */}
      <div
        className="relative bg-cover bg-center h-80 rounded-lg shadow-xl mb-10"
        style={{ backgroundImage: `url(${installationImage})` }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <h2 className="text-4xl md:text-5xl font-extrabold text-white text-center shadow-lg p-2">
      ...
      <p className="text-lg md:text-xl text-gray-700 text-center mb-10 px-4 md:px-16">
        ...
        services for residential, commercial, and industrial needs. Our expert team ensures quality and reliability from start to finish.
      </p>
      ...
      <div className="bg-white shadow-lg border-l-4 border-green-500 p-8 rounded-xl mb-12">
        ...
        <ol className="list-decimal pl-6 text-gray-700 space-y-4 text-sm md:text-base">
          <li>
            <strong className="font-semibold">Site Assessment:</strong> Our team visits your site to
            evaluate your energy needs and determine the best installation
            approach.
          </li>
          <li>
